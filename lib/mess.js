...
module.exports = {
    "pt_BR": {
        ...
        maxDuration: (max, maxType, mediaType, title, formatedTime) => {
            switch (maxType) {
                case 's':;
                    maxType = "segundo(s)";
                break;
            ...
            mediaType = mediaType == 'aud' ? "áudio" : "vídeo"; return `*Título:* ${title}\n\n*Duração:* ${formatedTime}\n\nOps! O ${mediaType} não pode conter mais que ${max} ${maxType} de duração! ⚠️`;
        },
            ...
            resp: ({ current, location }) => {
                ...
                var conditions = [
                    ...
                    },
                    {
						"code": 1063,
						"emoji": '🌧️',
						"name": "Probabilidad de lluvia irregular"
                    },
                    {
						"code": 1066,
						"emoji": '🌨️❄️',
						"name": "Probabilidad de nieve irregular"
                    },
                    {
						"code": 1069,
						"emoji": '🌨️💧',
						"name": "Probabilidad de nieve húmeda irregular"
                    },
                    {
						"code": 1072,
                  		"emoji": '🌧️❄️',
                   	   	"name": "Probabilidad de llovizna helada irregular"
                    },
                    {
						"code": 1087,
						"emoji": '⛈️',
                    ...
                    },
                    {
						"code": 1171,
						"emoji": '🌧️💧❄️',
						"name": "Llovizna helada intensa"
                    },
                    {
						"code": 1180,
						"emoji": '🌧️💧',
						"name": "Lluvia ligera irregular"
                    },
                    {
						"code": 1183,
						"emoji": '🌧️',
                    ...
                    },
                    {
						"code": 1186,
						"emoji": '🌧️',
						"name": "Períodos de lluvia moderada"
                    },
                    {
						"code": 1189,
						"emoji": '🌧️',
                    ...
                    },
                    {
						"code": 1192,
						"emoji": '🌧️🌧️',
						"name": "Períodos de fuertes lluvias"
                    },
                    {
						"code": 1195,
						"emoji": '🌧️🌧️',
                    ...
                    },
                    {
						"code": 1198,
						"emoji": '🌧️💧❄️',
						"name": "Lluvia ligera y fría"
                    },
                    {
						"code": 1201,
						"emoji": '⛈️❄️',
						"name": "Lluvia helada moderada o fuerte"
                    },
                    {
						"code": 1204,
						"emoji": '🌧️💧🌨️',
						"name": "Lluvia ligera con nieve"
                    },
                    {
						"code": 1207,
						"emoji": '🌧️🌨️',
						"name": "Lluvia fuerte o moderada con nieve"
                    },
                    {
						"code": 1210,
						"emoji": '🌨️',
						"name": "Nevadas irregulares y ligeras"
                    },
                    {
						"code": 1213,
                     	"emoji": '🌨️',
                    ...
                    },
                    {
						"code": 1216,
                    	"emoji": '🌨️',
                      	"name": "Nevadas moderadas e irregulares"
                    },
                    {
						"code": 1219,
                      	"emoji": '🌨️',
                      	"name": "Nevadas moderadas"
                    },
                    {
						"code": 1222,
                      	"emoji": '🌨️',
                      	"name": "Nevadas intensas e irregulares"
                    },
                    {
						"code": 1225,
                      	"emoji": '🌨️🌫️',
                    ...
                    },
                    {
						"code": 1240,
						"emoji": '💧💧',
						"name": "Chubascos ligeras"
                    },
                    {
						"code": 1243,
						"emoji": '💧💧💧',
						"name": "Lluvias moderadas o fuertes"
                    },
                    {
						"code": 1246,
						"emoji": '⛈️🌊',
                    ...
                    },
                    {
						"code": 1249,
						"emoji": '🌊💧🌨️',
						"name": "Lluvias ligeras con nieve"
                    },
                    {
						"code": 1252,
						"emoji": '🌊🌨️',
						"name": "Chubascos moderados o fuertes con nieve"
                    },
                    {
						"code": 1255,
						"emoji": '🌧️💧🌨️',
                    ...
                    },
                    {
						"code": 1258,
						"emoji": '🌧️🌨️',
						"name": "Lluvia moderada o fuerte con nieve"
                    },
                    {
						"code": 1261,
						"emoji": '🌊💧🧊',
						"name": "Chubascos ligeros con granizo"
                    },
                    {
						"code": 1264,
						"emoji": '🌊🧊',
						"name": "Chubascos moderados o fuertes con granizo"
                    },
                    {
						"code": 1273,
						"emoji": '🌧️💧⚡',
						"name": "Lluvia ligera irregular con tormenta"
                    },
                    {
						"code": 1276,
						"emoji": '🌧️⚡',
						"name": "Lluvias moderadas o fuertes con tormentas eléctricas"
                    },
                    {
						"code": 1279,
						"emoji": '🌨️💧⚡',
						"name": "Nieve ligera irregular con tormenta"
                    },
                    {
						"code": 1282,
						"emoji": '🌨️⚡',
						"name": "Nevadas moderadas o fuertes con tormentas eléctricas"
                    }
                ];
