...
module.exports = {
  "pt_BR": {
    ...
    stickerMetadataImg: (keepScale) => { return { author: 'OFICIAL', pack: 'Lune Bot', keepScale: keepScale, cropPosition: 'center' }; },
    stickerMetadataVideo: (fps, end, keepScale, crop) => { return { stickerMetadata: true, author: 'OFICIAL', pack: 'Lune Bot', fps: fps, startTime: '00:00:00.0', endTime: end, crop: crop, loop: 0, keepScale: keepScale }; },
    lang: () => { return `pt`; },
...
_By: Lune Bot_`;
  ...
  "en_US": {
    ...
    stickerMetadataImg: (keepScale) => { return { author: 'OFICIAL', pack: 'Lune Bot', keepScale: keepScale }; },
    stickerMetadataVideo: (fps, end, keepScale, crop) => { return { stickerMetadata: true, author: 'OFICIAL', pack: 'Lune Bot', fps: fps, startTime: '00:00:00.0', endTime: end, crop: crop, loop: 0, keepScale: keepScale }; },
    lang: () => { return `en`; },
...
🌐 Bot - Version ${version}`;
    ...
    "top10": {
      ...
      insuficientPlayers: (min) => { return `Não temos ${min} jogadores ainda, tente novamente mais tarde!`; },
      resp: (pos, usr, xp, lvl, role) => { return `${pos}. ${usr}\n➸ *XP*: ${xp}\n➸ *Level*: ${lvl}\n➸ *Patente*: ${role}\n\n`; },
      bott: (total) => { return `Total Players: ${total}\n\n`; },
    },
    "meme": {
      wrongUse: (cmd) => { return `Uso incorreto! Utilize *${cmd}* marcando uma imagem e ao lado (frase1) | (frase2)! ❌`; },
    },
