...
module.exports = {
    "pt_BR": {
        ...
        maxDuration: (max, maxType, mediaType) => { mediaType = mediaType == 'aud' ? "áudio" : "vídeo"; return `Ops! O ${mediaType} não pode conter mais que ${max} ${maxType.replace(/s/gi, "segundo(s)").replace(/m/gi, "minuto(s)").replace(/h/gi, "hora(s)").replace(/ms/gi, "milésimo(s)").replace(/d/gi, "dia(s)")} de duração! ⚠️`; },
        ...
        "ig": {
            onlyIgLinks: () => { return `Use apenas links do Instagram!`; },
            mediaFileIsTooLarge: () => { return `Me desculpe, mas o arquivo de midia é muito grande!`; },
        },
        "sys": {
        ...
        "softban": {
            wrongUse: (cmd) => { return `Uso incorreto! Utilize *${cmd}* <tempo><tipo de tempo (m, s, h)> em seguida marcando o membro ou marcando uma mensagem. 🚫`; },
            welcomeBack: (user) => { return `Bem vindo(a) de volta @${user}! 🚪✅`; },
            putMemberBack: () => { return `Está na hora de colocar o membro de volta! ✅`; },
            youReTemporarilyBanned: (user) => { return `${user} Você foi temporariamente banido! 🚫`; },
            invalidOption: (opt) => { return `O sufixo ${opt} não foi encontrado! Utilize "h" para hora(s), "m" para minuto(s) e "s" para segundo(s).` },
        },
        "meme": {
        ...
        "weather": {
            url: (query) => { return `http://api.weatherapi.com/v1/current.json?key=d3b6ee224cda44a8a0f231852221511&lang=pt&q=${encodeURIComponent(query)}`; },
...
_By: Lune Bot_`;
        ...
        "revoke": {
            success: () => { return `Link de grupo revogado com sucesso! ✅`; },
        },
        "promote": {
        ...
        "reboot": {
            resp: () => { return `Reiniciando hardware... 🖥️`; },
        },
        "stop": {
    ...
    "en_US": {
        ...
        maxDuration: (max, maxType, mediaType) => { mediaType = mediaType == 'aud' ? "audio" : "video"; return `Oops! The ${mediaType} cannot contain more than ${max} ${maxType.replace(/s/gi, "second(s)").replace(/m/gi, "minute(s)").replace( /h/gi, "hour(s)").replace(/ms/gi, "thousandth(s)").replace(/d/gi, "day(s)")} in duration! ⚠️`; },
        ...
        "ig": {
            onlyIgLinks: () => { return `Only use Instagram links!`; },
            mediaFileIsTooLarge: () => { return `Sorry, but the media file is too big!`; },
        },
        "sys": {
        ...
        "softban": {
            wrongUse: (cmd) => { return `Incorrect use! Use *${cmd}* <time><type of time (h, m, s)> tagging the member or quoting his message. 🚫 `; },
            welcomeBack: (user) => { return `Welcome back @${user}! 🚪✅`; },
            putMemberBack: () => { return `It's time to put the member back! ✅`; },
            youReTemporarilyBanned: (user) => { return `${user} You have been temporarily banned! 🚫`; },
            invalidOption: (opt) => { return `The suffix ${opt} was not found! Use "h" for hour(s), "m" for minute(s) and "s" for second(s).` },
        },
        "meme": {
        ...
        "weather": {
            url: (query) => { return `http://api.weatherapi.com/v1/current.json?key=d3b6ee224cda44a8a0f231852221511&lang=en&q=${encodeURIComponent(query)}`; },
            resp: ({ current, location }) => {
                var { condition, temp_c, temp_f, is_day, wind_kph, wind_mph, humidity, feelslike_c, feelslike_f, last_updated, precip_mm } = current;
                var { name, region, country, localtime } = location;
                var dayornight_emoji = is_day == 1 ? '☀️' : '🌙';
...
_By: Lune Bot_`;
        ...
        "revoke": {
            success: () => { return `Group link revoked successfully! ✅`; },
        },
        "promote": {
        ...
        "reboot": {
            resp: () => { return `Restarting hardware... 🖥️`; },
        },
        "stop": {
    ...
    "es_ES": {
        ...
        maxDuration: (max, maxType, mediaType) => { mediaType = mediaType == 'aud' ? "audio" : "video"; return `¡Ops! ¡El ${mediaType} No puede contener más de ${max} ${maxType.replace(/s/gi, "segundo(s)").replace(/m/gi, "minuto(s)").replace(/h/gi, "hora(s)").replace(/ms/gi, "milésimo(s)").replace(/d/gi, "dia(s)")} deduración! ⚠️`; },
...
/*
        "weather": {
            url: (query) => { return `http://api.weatherapi.com/v1/current.json?key=d3b6ee224cda44a8a0f231852221511&lang=es&q=${encodeURIComponent(query)}`; },
            resp: ({ current, location }) => {
                var { condition, temp_c, temp_f, is_day, wind_kph, wind_mph, humidity, feelslike_c, feelslike_f, last_updated, precip_mm } = current;
                var { name, region, country, localtime } = location;
                var dayornight_emoji = is_day == 1 ? '☀️' : '🌙';
                ...
                var conditions = [
                    ...
                    {
                        "emoji": "",
                        "name": "Lluvia  moderada a intervalos"
                    },
                    {
                        "emoji": "",
                        "name": "Nieve moderada a intervalos en las aproximaciones"
                    },
                    {
                        "emoji": "",
                        "name": "Aguanieve moderada a intervalos en las aproximaciones"
                    },
                    {
                        "emoji": "",
                        "name": "Llovizna helada a intervalos en las aproximaciones"
                    },
                    {
                        "emoji": "",
                    ...
                    {
                        "emoji": "",
                        "name": "Llovizna helada"
                    },
                    {
                        "emoji": "",
                        "name": "Fuerte llovizna helada"
                    },
                    {
                        "emoji": "",
                        "name": "Lluvias ligeras a intervalos"
                    },
                    {
                        "emoji": "",
                        "name": "Ligeras lluvias"
                    },
                    {
                        "emoji": "",
                        "name": "Periodos de lluvia moderada"
                    },
                    {
                        "emoji": "",
                    ...
                    {
                        "emoji": "",
                        "name": "Periodos de fuertes lluvias"
                    },
                    {
                        "emoji": "",
                        "name": "Fuertes lluvias"
                    },
                    {
                        "emoji": "",
                        "name": "Ligeras lluvias heladas"
                    },
                    {
                        "emoji": "",
                        "name": "Lluvias heladas fuertes o moderadas"
                    },
                    {
                        "emoji": "",
                        "name": "Ligeras precipitaciones de aguanieve"
                    },
                    {
                        "emoji": "",
                        "name": "Aguanieve fuerte o moderada"
                    },
                    {
                        "emoji": "",
                        "name": "Nevadas ligeras a intervalos"
                    },
                    {
                        "emoji": "",
                        "name": "Nevadas ligeras"
                    },
                    {
                        "emoji": "",
                        "name": "Nieve moderada a intervalos"
                    },
                    {
                        "emoji": "",
                        "name": "Nieve moderada"
                    ...
                    {
                        "emoji": "",
                        "name": "Nevadas intensas"
                    },
                    {
                        "emoji": "",
                        "name": "Fuertes nevadas"
                    },
                    {
                        "emoji": "",
                        "name": "Granizo"
                    ...
                    {
                        "emoji": "",
                        "name": "Ligeras precipitaciones"
                    },
                    {
                        "emoji": "",
                        "name": "Lluvias fuertes o moderadas"
                    },
                    {
                        "emoji": "",
                        "name": "Lluvias torrenciales"
                    },
                    {
                        "emoji": "",
                        "name": "Ligeros chubascos de aguanieve"
                    },
                    {
                        "emoji": "",
                        "name": "Chubascos de aguanieve fuertes o moderados"
                    },
                    {
                        "emoji": "",
                        "name": "Ligeras precipitaciones de nieve"
                    },
                    {
                        "emoji": "",
                        "name": "Chubascos de nieve fuertes o moderados"
                    },
                    {
                        "emoji": "",
                        "name": "Ligeros chubascos acompañados de granizo"
                    },
                    {
                        "emoji": "",
                        "name": "Chubascos fuertes o moderados acompañados de granizo"
                    },
                    {
                        "emoji": "",
                        "name": "Intervalos de lluvias ligeras con tomenta en la región"
                    },
                    {
                        "emoji": "",
                        "name": "Lluvias con tormenta fuertes o moderadas en la región"
                    },
                    {
                        "emoji": "",
                        "name": "Nieve moderada con tormenta en la región"
                    },
                    {
                        "emoji": "",
                        "name": "Nieve moderada o fuertes nevadas con tormenta en la región"
                    }
                ];
...
🔭 Condición: ${conditions[pos].name} ${conditions[pos].emoji}
